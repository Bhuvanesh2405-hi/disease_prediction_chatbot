    ...
    for idx in top_indices:
        ...
        if confidence >= confidence_threshold:
            ...
            predictions.append({
                ...
                'description': disease_descriptions.get(disease.strip().lower(), "No description available"),
                'precautions': [p for p in disease_precautions.get(disease.strip().lower(), ["No specific precautions available"]) 
